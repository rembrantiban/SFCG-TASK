...
const TaskCoordinatorheader = ({ name = "Staff" }) => {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 shadow-md border border-gray-700/60 px-6 py-3 text-white">
        ...
        <div className="flex items-center">
          ...
          <div className="px-2 leading-tight">
            ...
            <h1 className="text-lg font-semibold leading-tight">
              Welcome, <span className="text-amber-400">{user.firstName}</span> 👋
            </h1>
      ...
      <div className="hidden sm:grid grid-cols-4 gap-3">
        <ActionCard iconBg="bg-amber-500" icon={<ClipboardList size={18} />} link="/request/taskpresident" text="Request" />
      ...
      <AnimatePresence>
        {openMenu && (
          ...
          >
            <ActionCard iconBg="bg-amber-500" icon={<ClipboardList size={18} />} link="/request/taskpresident" text="Request" full />
...
export default TaskCoordinatorheader;
